...
export default function Board({
  ...
  const [lineMode, setLineMode] = useState('curved'); // 'curved' | 'straight'
  ...
  return (
    <main ref={boardLayoutRef} className="board-page-layout">
      ...
      <div className="board-top-toolbar">
        ...
        {/* Right: Quick Search, Line Style & Export in Canvas */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          {/* Line Style Switcher */}
          <div style={{ display: 'flex', gap: '2px', background: 'var(--paper)', border: '1px solid var(--border)', borderRadius: '3px', padding: '2px' }}>
            <button
              onClick={() => setLineMode('curved')}
              className={`hud-btn ${lineMode === 'curved' ? 'active' : ''}`}
              style={{ padding: '2px 6px', fontSize: '10px', background: lineMode === 'curved' ? 'var(--tag-amber)' : 'transparent', color: lineMode === 'curved' ? 'var(--on-amber)' : 'var(--ink)', border: 'none' }}
              title="Curved Natural Threads"
            >
              🧵 Curve
            </button>
            <button
              onClick={() => setLineMode('straight')}
              className={`hud-btn ${lineMode === 'straight' ? 'active' : ''}`}
              style={{ padding: '2px 6px', fontSize: '10px', background: lineMode === 'straight' ? 'var(--tag-amber)' : 'transparent', color: lineMode === 'straight' ? 'var(--on-amber)' : 'var(--ink)', border: 'none' }}
              title="Straight Tactical Vectors"
            >
              📏 Straight
            </button>
          </div>
          ...
          <div style={{ display: 'flex', gap: '4px' }}>
            <button
              ...
              style={{ padding: '4px 8px', fontSize: '10px', fontFamily: 'IBM Plex Mono, monospace' }}
          ...
          <span style={{ fontSize: '10px', fontFamily: 'IBM Plex Mono, monospace', color: 'var(--ink-muted)' }}>
