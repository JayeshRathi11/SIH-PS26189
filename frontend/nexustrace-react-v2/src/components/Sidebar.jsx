          ...
          {!showAddForm ? (
            ...
            <form className="add-case-form" onSubmit={handleAddSubmit}>
              ...
              <input
                ...
                required
              />
              <label className="add-case-file-label" style={{ fontSize: '10.5px', color: 'var(--ink-muted)', display: 'block', marginTop: '4px' }}>
                Case documents (.txt, .docx, .pdf) -- extraction runs on these:
              </label>
              <input
                type="file"
                multiple
              ...
              {newCaseFiles.length > 0 && (
                <div style={{ fontSize: '10px', color: 'var(--ink-muted)' }}>
                  {newCaseFiles.length} file(s) selected
                </div>
              )}
