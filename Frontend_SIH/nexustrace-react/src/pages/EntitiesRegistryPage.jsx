...
export default function EntitiesRegistryPage({
  ...
  const entityTypes = [
    { id: 'ALL', label: 'All POLE Assets' },
    { id: 'person', label: 'Persons (Suspects)' },
    { id: 'location', label: 'Locations & Safehouses' },
    { id: 'org', label: 'Front Organizations' },
    { id: 'vehicle', label: 'Vehicles' },
    { id: 'phone', label: 'Phone Intercepts' },
  ...
  return (
    <div className="page-container">
      ...
      <div className="page-header-row">
        <div>
          <div className="page-eyebrow">● POLE KNOWLEDGE GRAPH ASSETS</div>
          <h2 className="page-title">Entities Registry & Intelligence Catalog</h2>
          <p className="page-subtitle">
            Centralized database of all Persons, Objects/Vehicles, Locations, and Events identified across multi-jurisdictional crime verticals.
          </p>
        </div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px', marginBottom: '20px' }}>
        ...
        <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
          ...
          <select
            ...
            style={{ width: '160px' }}
          >
            <option value="centrality">Sort: Centrality Score</option>
            <option value="connections">Sort: Direct Links</option>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '14px', marginBottom: '20px' }}>
        <div className="stat-summary-card">
          <div className="stat-summary-title">Total Entities Cataloged</div>
        ...
        <div className="stat-summary-card">
          <div className="stat-summary-title">Identified Safehouses & Locations</div>
      ...
      <div style={{ background: 'var(--panel)', border: '1px solid var(--border)', borderRadius: '4px', overflow: 'hidden' }}>
        <div style={{ padding: '14px 18px', borderBottom: '1px solid var(--border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <span style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: '11px', fontWeight: 600, color: 'var(--ink)' }}>
            INDEXED ASSETS ({filteredEntities.length})
          </span>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '12px' }}>
            <thead>
              <tr style={{ background: 'var(--paper)', borderBottom: '1px solid var(--border)', fontFamily: 'IBM Plex Mono, monospace', fontSize: '10.5px', color: 'var(--ink-soft)', textTransform: 'uppercase' }}>
                <th style={{ padding: '10px 14px' }}>Asset / Subject Name</th>
                <th style={{ padding: '10px 14px' }}>POLE Type</th>
                <th style={{ padding: '10px 14px' }}>Known Aliases</th>
                <th style={{ padding: '10px 14px' }}>Direct Links</th>
                <th style={{ padding: '10px 14px' }}>Centrality Rank</th>
              ...
              {filteredEntities.length === 0 ? (
                <tr>
                  <td colSpan={7} style={{ textAlign: 'center', padding: '40px 14px', color: 'var(--ink-muted)' }}>
                    No entities matching the query filter.
                  </td>
                </tr>
              ) : (
                      ...
                      <td style={{ padding: '12px 14px', textAlign: 'right' }}>
                        <div style={{ display: 'inline-flex', gap: '6px' }}>
                          <button
                            ...
                            title="Inspect on interactive Corkboard"
                          >
                            📌 Corkboard
                          </button>
                          <a
                            ...
                            style={{ padding: '3px 8px', fontSize: '10.5px' }}
                            title="Download Court Dossier PDF"
                          >
                            📄 PDF
                          </a>
                        </div>
